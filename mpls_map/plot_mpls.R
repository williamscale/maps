...
streets <- read_sf(dsn = 'D:/mpls_map/MPLS_Centerline')
water <- read_sf(dsn = 'D:/mpls_map/Water-shp')
parks <- read_sf(dsn = 'D:/mpls_map/Parks-shp') %>%
  filter(PARK_NAME1 != 'MEADOWBROOK GOLF',
         PARK_NAME1 != 'FORT SNELLING')
